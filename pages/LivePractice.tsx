...
export const LivePractice = () => {
    ...
    const startSession = async () => {
        ...
        try {
            ...
            session.sendClientContent({ turns: [{ role: 'user', parts: [{ text: "Start the conversation now. Greet me in Finnish and English and ask a simple question." }] }], turnComplete: true });

        } catch (e) {
            console.error(e);
            console.error(e);
            alert(`Connection Error: ${e instanceof Error ? e.message : String(e)}`);
        }
    };
