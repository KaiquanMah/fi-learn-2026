...
* Draft app in AI Studio: https://ai.studio/apps/drive/1C-ZMeP_8SBTFpXKv4V96My5x1_AIEEtr
* Fixed app in Antigravity: In this repo
* To understand
  ...
  * The curriculum researched by Gemini 3 Pro in AI Studio, visit `data/curriculum.ts` and `data/curriculum.md`
    * The words and sentences found in the curriculum were used to generate a corresponding audio/mp3 file, which is stored in the `public/audio` folder, with file naming convention: `{finnish word or sentence}.mp3`
* 3-minute demo video for the 2026.01.10 Saturday - SG Gemini Hackathon
