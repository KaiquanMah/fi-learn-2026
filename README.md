...
* To understand
  ...
  * The curriculum researched by Gemini 3 Pro in AI Studio, visit `data/curriculum.ts` and `data/curriculum.md`
    * The words and sentences found in the curriculum were used to generate a corresponding audio/mp3 file, which is stored in `public/audio` using the 'finnish word or sentence' as the filename
